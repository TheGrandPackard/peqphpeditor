...
<? if (isset($horses)):?>
         <tr>
          ...
          <td align="center" width="1%"><strong>Texture</strong></td>
          <td align="center" width="8%"><strong>Speed</strong></td>
          <td align="center" width="12%"><strong>Notes</strong></td>
          <td align="center" width="4%"><strong>Min<br/>Expan.</strong></td>
          <td align="center" width="4%"><strong>Max<br/>Expan.</strong></td>
          <th width="5%"></th>
         </tr>
<?$x=0; foreach($horses as $horses=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
          ...
          <td align="center" width="1%"><?=$v['texture']?></td>   
