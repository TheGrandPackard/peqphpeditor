...
<?if (isset($doors)):?>
        <tr>
          ...
          <td align="center" width="5%"><strong>Lock Pick</strong></td>
          <td align="center" width="5%"><strong>Key</strong></td>
          <td align="center" width="5%"><strong>Type</strong></td>
          <td align="center" width="7%"><strong>Dest Zone</strong></td>
          <td align="center" width="5%"><strong>Dest X</strong></td>
          <td align="center" width="5%"><strong>Dest Y</strong></td>
          <td align="center" width="5%"><strong>Dest Z</strong></td>
...
<?$x=0; foreach($doors as $door=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
          ...
          <td align="center" width="8%"><?=$v['pos_z']?></td>
          <td align="center" width="5%"><?=$v['lockpick']?></td> 
<?if($v['keyitem'] < 1):?>  
          <td align="center" width="5%"><?=$v['keyitem']?></td> 
<?endif;?>
<?if($v['keyitem'] > 0):?>  
...
<?endif;?>
          ...
          <td align="center" width="5%"><?=$v['dest_x']?></td>
          <td align="center" width="5%"><?=$v['dest_y']?></td>
          <td align="center" width="5%"><?=$v['dest_z']?></td>
